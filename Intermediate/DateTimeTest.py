...
def time_for_milk_and_cookies(date: datetime.date):
    return isinstance(date, datetime.date) and date.day == 24 and date.month == 12


assert time_for_milk_and_cookies(datetime.date(2013, 12, 24)) is True
